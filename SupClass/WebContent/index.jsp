...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">메인페이지</span>
            </a>
					</li>
				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							 ...
							 <a><img src="fileUpload/가족.jpg" class="align-middle mr-1"> </a>
						</div>
	...
	<c:choose>
		<c:when test="${sessionScope.loginId eq 'admin'}">
			<h1>관리자모드로 접속중입니다.</h1>
			<button onclick="location.href='BM_Write.jsp'">글쓰기</button>
			<button onclick="location.href='BMlist'">게시판 목록보기</button>
			<button onclick="location.href='MBlist'">회원목록</button>
			<button onclick="location.href='MBlogout'">로그아웃</button>
		</c:when>


		<c:when test="${sessionScope.loginId !=null}">
			<h1>${sessionScope.loginId}님이접속중입니다.</h1>
			<button onclick="location.href='BM_Write.jsp'">글쓰기</button>
			<button onclick="location.href='BMlist'">게시판 목록보기</button>
			<button onclick="location.href='MBview?mId=${sessionScope.loginId}'">내정보보기</button>
			<button onclick="location.href='MBlogout'">로그아웃</button>
		</c:when>
		
		<c:otherwise>
			<button onclick="location.href='BMlist'">게시판 목록보기</button>
			<button onclick="location.href='MB_Join.jsp'">회원가입</button>
			<button onclick="location.href='MB_Login.jsp'">로그인</button>
			<h1>${fail}</h1>
