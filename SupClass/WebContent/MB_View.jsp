			...
			<div class="container-fluid p-0">
				...
				<div class="row">
					<div class="col-12 col-xl-6">
						...
						<table>
							<caption>${member.mId}님의회원정보</caption>
							<tr>
								<th>아이디</th>
								<td>${member.mId}</td>
							</tr>
							...
							<tr>
								<th>사진</th>
								<td><img src="fileUpload/${member.mFile}" width="200px"></td>
							</tr>

							<tr>
								<td colspan="2">
									<button onclick="location.href='MBmodiForm?mId=${member.mId}'">수정하기</button>
									<button onclick="location.href='MBdelete?mId=${member.mId}'">탈퇴하기</button>
								</td>
							</tr>
