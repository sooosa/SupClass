	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<div class="container-fluid p-0">
				...
				<form action="MBmodify" method="POST" enctype="multipart/form-data">
					<table>
						<caption>${modify.mId}님회원정보 수정</caption>
						<tr>
							<td>아이디</td>
							<td>${modify.mId}<input type="hidden" name="mId"
								value="${modify.mId}"></td>
