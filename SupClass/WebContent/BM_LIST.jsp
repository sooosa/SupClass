						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">게시판목록(☞ﾟヮﾟ)☞</h5>
								</div>
								<table class="table">
									<thead>
										<tr>
									...
									<tbody>
										...
										<c:forEach var="board" items="${boardlist}">
											<tr>
												<td class="td0">${board.bNum}</td>
												<td class="td1">${board.bId}</td>
												<td class="td2"><a href="BMview?bNum=${board.bNum}">${board.bTitle}</a></td>
												<td class="td3">${board.bDate}</td>
												<td class="td4">${board.bHits}</td>
											</tr>
										</c:forEach>
								</table>
							</div>
