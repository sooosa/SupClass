						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">작성글보기</h5>
									<h6 class="card-subtitle text-muted"></h6>
								</div>
								<table class="table">
									<thead>
									<caption>${board.bId}님의작성한글입니다.</caption>
									<tr>
										<th>작성자</th>
										<td>${board.bId}</td>
									</tr>
									...
									<tr>
										<th>파일</th>
										<td><img src="fileUpload/${board.bFile}" width="200px"></td>
									</tr>

									<tr>
										<td colspan="2">
											<button
												onclick="location.href='BMmodiForm?bNum=${board.bNum}'">수정하기</button>
											<button onclick="location.href='BMdelete?bNum=${board.bNum}'">삭제</button>
										</td>
									</tr>
